    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.drugs.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('rxcui') ? 'is-invalid' : '' }}" type="text" name="rxcui" id="rxcui" value="{{ old('rxcui', '') }}" required>
                @if($errors->has('rxcui'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('side_effects') ? 'is-invalid' : '' }}" name="side_effects" id="side_effects">{!! old('side_effects') !!}</textarea>
